...
class MyGoalsBaseProjectSupabaseUser extends BaseAuthUser {
  MyGoalsBaseProjectSupabaseUser(this.user);
  User? user;
  @override
...
Stream<BaseAuthUser> myGoalsBaseProjectSupabaseUserStream() {
  ...
  return (!loggedIn
      ...
      .map<BaseAuthUser>(
    (authState) {
      currentUser = MyGoalsBaseProjectSupabaseUser(authState?.session?.user);
      return currentUser!;
    },
  );
}
