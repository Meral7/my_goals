...
class _CreateGoalComponentWidgetState extends State<CreateGoalComponentWidget> {
  ...
  void initState() {
    ...
    _model.goalTextFieldController ??= TextEditingController();
    _model.goalTextFieldFocusNode ??= FocusNode();
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                controller: _model.goalTextFieldController,
                focusNode: _model.goalTextFieldFocusNode,
                obscureText: false,
                ...
                minLines: null,
                validator: _model.goalTextFieldControllerValidator
                    .asValidator(context),
              ),
            ),
            Padding(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  contentPadding:
                      const EdgeInsetsDirectional.fromSTEB(20.0, 32.0, 20.0, 20.0),
                ),
                style: FlutterFlowTheme.of(context).bodyMedium.override(
                      fontFamily: 'Poppins',
                      color: FlutterFlowTheme.of(context).primaryText,
                ...
                validator: _model.descriptionTextFieldControllerValidator
                    .asValidator(context),
              ),
            ),
            Padding(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      ...
                      await GoalsTable().insert({
                        'title': _model.goalTextFieldController.text,
                        'description':
