...
class _UpdateGoalComponentWidgetState extends State<UpdateGoalComponentWidget> {
  ...
  void initState() {
    ...
    _model.taskTextFieldController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.goal?.title,
      'title',
    ));
    _model.taskTextFieldFocusNode ??= FocusNode();

    _model.descriptionTextFieldTaskController ??= TextEditingController(
        text: valueOrDefault<String>(
      widget.goal?.description,
      'desc',
    ));
    _model.descriptionTextFieldTaskFocusNode ??= FocusNode();
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: TextFormField(
                controller: _model.taskTextFieldController,
                focusNode: _model.taskTextFieldFocusNode,
                obscureText: false,
                ...
                minLines: null,
                validator: _model.taskTextFieldControllerValidator
                    .asValidator(context),
              ),
            ),
            Padding(
              padding: const EdgeInsetsDirectional.fromSTEB(16.0, 16.0, 16.0, 0.0),
              child: TextFormField(
                controller: _model.descriptionTextFieldTaskController,
                focusNode: _model.descriptionTextFieldTaskFocusNode,
                obscureText: false,
                decoration: InputDecoration(
                  hintText: 'Enter  tour goal description',
                  hintStyle: FlutterFlowTheme.of(context).labelMedium.override(
                        fontFamily: 'Plus Jakarta Sans',
                        color: FlutterFlowTheme.of(context).secondaryText,
                        fontSize: 14.0,
                ...
                validator: _model.descriptionTextFieldTaskControllerValidator
                    .asValidator(context),
              ),
            ),
            Padding(
                  ...
                  FFButtonWidget(
                    onPressed: () async {
                      ...
                      await TasksTable().update(
                        data: {
                          'title': _model.taskTextFieldController.text,
                          'description':
                              _model.descriptionTextFieldTaskController.text,
                        },
                        matchingRows: (rows) => rows.eq(
                          'id',
                          valueOrDefault<int>(
